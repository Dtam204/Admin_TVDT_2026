...
import { useBookCategories, useDeleteBookCategory } from '@/lib/hooks/useBookCategories';
...
export default function BookCategoriesPage() {
  ...
  const { mutate: deleteItem } = useDeleteBookCategory();
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Quản lý toàn bộ thể loại sách
          </p>
        </div>
        <Link href="/admin/book-categories/new">
          <Button size="lg">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Thể loại sách</TableHead>
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex gap-2 justify-end">
                        <Link href={`/admin/book-categories/${item.id}`}>
