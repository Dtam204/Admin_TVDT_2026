...
import { useCourse, useDeleteCourse } from '@/lib/hooks/useCourses';
...
export default function CourseDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data, isLoading } = useCourse(itemId);
  const { mutate: deleteItem, isPending: isDeleting } = useDeleteCourse();
